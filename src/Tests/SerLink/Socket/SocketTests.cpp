...
static Event uartRx(uartRxHandler);  // **** MUST be static - otherwise stack overflow
...
void SocketTests::RxThenStdAck()
{
  ...
  static SerLink::Frame rxFrame("TST04", SerLink::Frame::TYPE_TRANSMISSION, 615, rxFrameBuffer, 5, "hello");
